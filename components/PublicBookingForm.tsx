    ...
    return (
        <div className={`template-wrapper template-${template} min-h-screen p-4 sm:p-6 lg:p-8 flex items-center justify-center`}>
            ...
            <div ref={formRef} className="form-container">
                {template === 'modern' && (
                    <div className="p-8 bg-public-surface rounded-2xl border border-public-border hidden md:block">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-2">
                             <div className="space-y-4">
                                <h4 className="text-base font-semibold text-gradient border-b border-public-border pb-2">Informasi Klien</h4>
