...
const SupabaseLogin: React.FC<SupabaseLoginProps> = ({ onLoginSuccess }) => {
      ...
      <div className="w-full max-w-sm mx-auto">
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
          ...
          <div className="text-center mt-6 text-xs text-slate-400 bg-slate-50 p-3 rounded-lg">
            <p className="font-bold text-slate-500">Untuk testing, gunakan Supabase Auth</p>
            <p>Daftar akun baru atau masuk dengan email/password</p>
          </div>
        </div>
      </div>
    </div>
