...
const DashboardTab: React.FC<{ client: Client; projects: Project[], profile: Profile }> = ({ client, projects, profile }) => {
    ...
    return (
        <div className="space-y-6">
            {upcomingProject && (
                 <div className="portal-surface p-6 rounded-2xl shadow-md border widget-animate" style={{ animationDelay: '100ms' }}>
             ...
             <div className="portal-surface p-6 rounded-2xl shadow-md border widget-animate" style={{ animationDelay: '200ms' }}>
            ...
            {activeProject && (
                <div className="portal-surface p-6 rounded-2xl shadow-md border widget-animate" style={{ animationDelay: '600ms' }}>
...
const GalleryTab: React.FC<{ projects: Project[], packages: Package[] }> = ({ projects, packages }) => (
    <div className="space-y-6">
        {projects.map((project, index) => {
            ...
            return (
                <div key={project.id} className="portal-surface p-6 rounded-2xl shadow-md border widget-animate" style={{ animationDelay: `${index * 100}ms` }}>
...
const ContractsTab: React.FC<{ contracts: Contract[], projects: Project[], onViewContract: (contract: Contract) => void }> = ({ contracts, projects, onViewContract }) => (
    <div className="portal-surface p-6 rounded-2xl shadow-md border widget-animate">
...
const FeedbackTab: React.FC<{client: Client, setClientFeedback: any, showNotification: any}> = ({ client, setClientFeedback, showNotification }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="portal-surface p-6 rounded-2xl shadow-md border flex flex-col widget-animate">
