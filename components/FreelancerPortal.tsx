    ...
    return (
        <div className="min-h-screen bg-public-bg text-public-text-primary p-4 sm:p-6 lg:p-8">
            <div className="max-w-5xl mx-auto">
                <header className="mb-8 p-6 bg-public-surface rounded-2xl shadow-lg border border-public-border widget-animate">
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             ...
             <div className="bg-public-surface p-6 rounded-2xl shadow-lg border border-public-border widget-animate" style={{ animationDelay: '600ms' }}>
...
const PaymentsTab: React.FC<{freelancer: TeamMember, projects: Project[], teamProjectPayments: TeamProjectPayment[], teamPaymentRecords: TeamPaymentRecord[], onSlipView: (record: TeamPaymentRecord) => void}> = ({ freelancer, projects, teamProjectPayments, teamPaymentRecords, onSlipView }) => (
    <div className="bg-public-surface p-6 rounded-2xl shadow-lg border border-public-border widget-animate">
    ...
    return (
        <div className="space-y-6">
            {relevantSops.length > 0 && (
                <div className="bg-public-surface p-6 rounded-2xl shadow-lg border border-public-border widget-animate" style={{ animationDelay: '100ms' }}>
